...
Cypress.Commands.add(
  ...
  function (fixtureFileName, funcMockedOn) {
    cy.intercept('GET', SEC_API_CONFIG_PATH, {
...
Cypress.Commands.add(
  ...
  function (fixtureFileName, funcMockedOn) {
    cy.intercept('GET', SEC_API_INTERNAL_USERS_PATH, {
      fixture: fixtureFileName,
...
Cypress.Commands.add(
  ...
  function (fixtureFileName, funcMockedOn) {
    cy.intercept('GET', SEC_API_ACTIONGROUPS_PATH, {
      fixture: fixtureFileName,
    }).as('getPermissions');
...
Cypress.Commands.add(
  'mockTenantsAction',
  function (fixtureFileName, funcMockedOn) {
    cy.intercept('GET', SEC_API_TENANTS_PATH, {
      fixture: fixtureFileName,
    }).as('getTenants');
...
Cypress.Commands.add(
  'mockAuditLogsAction',
  function (fixtureFileName, funcMockedOn) {
    cy.intercept('GET', SEC_API_AUDIT_PATH, {
      fixture: fixtureFileName,
    }).as('getAuditInfo');
...
Cypress.Commands.add(
  ...
  function (fixtureFileName, funcMockedOn) {
    cy.intercept('POST', SEC_API_AUDIT_CONFIG_PATH, {
      fixture: fixtureFileName,
    }).as('configUpdate');
...
Cypress.Commands.add(
  ...
  function (fixtureFileName, funcMockedOn) {
    cy.intercept('DELETE', SEC_API_CACHE_PURGE_PATH, {
      fixture: fixtureFileName,
    }).as('purgeCache');
